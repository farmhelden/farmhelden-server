"""
Django settings for farmhelden project.
...
SECRET_KEY = '0-(crw$ad#os$gc=3ixo!r&o28#2bq@ia!xf!)w+&i1+4l3i*='
...
WSGI_APPLICATION = 'farmhelden.wsgi.application'
...
AUTH_USER_MODEL = "rest_server.User"
